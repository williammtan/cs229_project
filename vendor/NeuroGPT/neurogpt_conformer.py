"""Vendored from github.com/wenhui0206/NeuroGPT src/encoder/conformer_braindecode.py (import path fixed; otherwise verbatim)."""
...
from neurogpt_base import EEGModuleMixin, deprecated_args
